...
- **Basic Example**: `examples/basic/` - Image-to-video generation with metadata tracking
...
```bash
# Runway API base URL (defaults to Runway Developer API)
RUNWAY_BASE_URL=https://api.dev.runwayml.com

# Runway API version
RUNWAY_VERSION=2024-11-06

# HTTP request timeout (default: 300s)
# Supports Go duration format: "300s", "5m", "1h"
# Or plain seconds: "300"
RUNWAY_REQUEST_TIMEOUT=300s
